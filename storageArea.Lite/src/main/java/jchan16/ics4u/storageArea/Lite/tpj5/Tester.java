...
//        System.out.println("\n");
        ...
        //Put entries into program when first starting up
        e.editAddEntry(e.getNewEntryID(), a.coin(), a.randoSub(), a.randoDate(), a.randoAmount(a.coin()), a.randoNotes());
        e.editAddEntry(e.getNewEntryID(), a.coin(), a.randoSub(), a.randoDate(), a.randoAmount(a.coin()), a.randoNotes());
        e.editAddEntry(e.getNewEntryID(), a.coin(), a.randoSub(), a.randoDate(), a.randoAmount(a.coin()), a.randoNotes());
        e.editAddEntry(e.getNewEntryID(), a.coin(), a.randoSub(), a.randoDate(), a.randoAmount(a.coin()), a.randoNotes());
        e.editAddEntry(e.getNewEntryID(), a.coin(), a.randoSub(), a.randoDate(), a.randoAmount(a.coin()), a.randoNotes());
       ...
       e.clearArray2();
        ...
        //Edits
       e.readFromFile(e.getFileName2("log1"));
        e.editRemoveEntry(5);
        e.editRemoveEntry(2);
        ...
        e.getFileNames();
        System.out.println("\n");
        e.writeLogReplace(e.getFileName2("Test"),e.masterSave(e.getArray2()));
        e.printArray2();
        System.out.println("\n");
