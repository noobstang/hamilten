...
//if file is put in , current file is changed to the file path of the file
    ...
    //resesy currentFile to nothing,mostlikely used if they close the program after edits have been preformed
...
//returns the file path that the program has read from 
